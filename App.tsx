    ...
    <div className="min-h-screen bg-white text-slate-900 selection:bg-dara-cyan/20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3">
              {/* Logo from Dara Voice Tech */}
              <img 
                src="https://daravoicetech.com/wp-content/uploads/2024/12/Dara-Voice-Tech-Logo.png" 
                alt="Dara Voice Tech" 
      ...
      <div className="relative pt-20 pb-16 sm:pt-32 sm:pb-24 overflow-hidden bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
          <div className="inline-block px-4 py-1.5 rounded-full bg-slate-50 border border-slate-200 text-dara-navy text-sm font-bold mb-8 tracking-wide uppercase">
             AI-Powered Front Desk for Vet Clinics
          </div>
          ...
          <p className="mt-6 max-w-2xl mx-auto text-xl text-slate-600 leading-relaxed">
            Dara Voice Tech provides human-like AI receptionists for <strong>Veterinary Clinics</strong>. 
      ...
      <div className="py-24 bg-white" id="features">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-dara-navy mb-4">Why Choose Dara Voice Tech?</h2>
      ...
      <footer className="bg-slate-50 py-12 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 text-center text-slate-500">
          ...
          <p className="text-sm font-medium">&copy; 2025 Dara Voice Tech. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
